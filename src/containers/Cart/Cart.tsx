    ...
    return (
        <div className="row mt-42">
            <div className="col-12">
               <h2 className="text-center mb-4 mt-4 text-white text-uppercase">Cart</h2>
            {cart}
            <Modal show={show} title={'Order'} onClose={() => setShow(false)}>
                ...
                <div className="modal-footer mt-4">
                    ...
                    <button className="btn btn-warning text-white" onClick={() => navigate('/checkout')}>Continue</button>
                </div>
            </Modal> 
            </div>
        </div>
